...
allowed to move the tier down (never up) relative to the deterministic mechanical fallback that runs
if it fails. See that amendment for the full guardrails.
